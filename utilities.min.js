...
export const DATA_TYPES={ARRAY:'array',BIGINT:'bigint',BOOLEAN:'boolean',DATE:'date',ERROR:'error',MAP:'map',NULL:'null',NUMBER:'number',OBJECT:'object',REGEXP:'regexp',SET:'set',STRING:'string',SYMBOL:'symbol',UNDEFINED:'undefined',};export function dataType(subject){return Object.prototype.toString.call(subject).slice(8,-1).toLowerCase();}
...
export function sum(...nums){nums.forEach(num=>{if(dataType(num)!==DATA_TYPES.NUMBER){throw Error(`Error:E-NN An argument supplied is not a Numeric value.`);}});return nums.reduce((tot,num)=>tot+num,0);}